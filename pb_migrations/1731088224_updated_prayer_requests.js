...
migrate((db) => {
  ...
  collection.listRule = "user.followers:each ~ @request.auth.id || user = @request.auth.id"
  collection.viewRule = "user.followers:each ~ @request.auth.id || user = @request.auth.id"
